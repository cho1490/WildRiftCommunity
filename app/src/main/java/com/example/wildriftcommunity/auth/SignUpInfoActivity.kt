...
import com.example.wildriftcommunity.databinding.ActivitySignUpInfoBinding
import kotlinx.android.synthetic.main.activity_login.*
import org.kodein.di.KodeinAware
import org.kodein.di.android.kodein
import org.kodein.di.generic.instance

class SignUpInfoActivity : AppCompatActivity(), ProgressListener, KodeinAware {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_sign_up_info)
        binding.authViewModel = viewModel
        binding.lifecycleOwner = this

        viewModel.checkNickname.observe(this, Observer {
            if (it == true){
                viewModel.setCheckNicknameValue(
